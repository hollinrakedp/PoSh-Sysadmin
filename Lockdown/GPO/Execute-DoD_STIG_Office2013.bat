...
goto EndComment
:Comment
Name         - Execute-DoD_STIG_Office2013.bat
Version      - 1.0
...
.SYNOPSIS
Apply the DISA Group Policy for Office 2013 against the local machine.
...
:Variables
SETLOCAL
set STIG=DoD Office System 2013 and Components
