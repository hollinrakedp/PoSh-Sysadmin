...
goto EndComment
:Comment
Name         - Execute-Custom_GPO_NetBanner_SecretNoForn.bat
Version      - 1.0
...
.SYNOPSIS
Apply the Custom Group Policy for NetBanner Secret NoForn against the local machine.
...
:Variables
SETLOCAL
set GPO=Custom - Computer - NetBanner - Secret NoForn
