...
goto EndComment
:Comment
Name         - Execute-Custom_GPO_RemovableStorage_DenyAny.bat
Version      - 1.0
...
.SYNOPSIS
Apply the Custom Group Policy for Removable Storage Deny Any against the local machine.
...
:Variables
SETLOCAL
set GPO=Custom - User - Removable Storage - Deny Any
