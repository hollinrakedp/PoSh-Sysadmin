...
goto EndComment
:Comment
Name         - Execute-Custom_GPO_NetBanner_Test.bat
Version      - 1.0
...
.SYNOPSIS
Apply the Custom Group Policy for NetBanner Test against the local machine.
...
:Variables
SETLOCAL
set GPO=Custom - Computer - NetBanner - Unclassified Test System
