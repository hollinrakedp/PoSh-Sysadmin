...
goto EndComment
:Comment
Name         - Execute-Custom_GPO_NetBanner_Unclass.bat
Version      - 1.0
...
.SYNOPSIS
Apply the Custom Group Policy for NetBanner Unclassified against the local machine.
...
:Variables
SETLOCAL
set GPO=Custom - Computer - NetBanner - Unclassified
