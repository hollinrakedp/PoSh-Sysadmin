...
goto EndComment
:Comment
Name         - Execute-Custom_GPO_AppLockerAudit.bat
Version      - 1.0
...
.SYNOPSIS
Apply the Custom Group Policy for AppLocker Auditing against the local machine.
...
:Variables
SETLOCAL
set GPO=Custom - Computer - AppLocker - Audit Only
